...
<section class="bg-[#077cf8] text-white py-16 text-center">
    <div class="container mx-auto px-6 max-w-7xl">
        ...
        <p class="text-lg mx-auto max-w-2xl my-4 text-white opacity-100">Let's connect. Get a free, no-obligation consultation to discover how we can fulfill your talent needs.</p>
